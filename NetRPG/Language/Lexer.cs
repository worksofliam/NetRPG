...
namespace NetRPG.Language
{
    public class RPGLex
    {
        public enum Type
        {
            BLOCK, UNKNOWN, OPERATOR, STRING_LITERAL, BLOCK_OPEN, BLOCK_CLOSE, DCL, ENDDCL, OPERATION, BIF, SPECIAL, DIRECTIVE, INT_LITERAL, DOUBLE_LITERAL, WORD_LITERAL, EQUALS, PARMS, STMT_END, DOT, ADD, SUB, DIV, MUL, LESS_THAN, MORE_THAN, NOT, MT_EQUAL, LT_EQUAL
        }
