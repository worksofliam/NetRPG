...
namespace NetRPG.Runtime.Typing.Files
{
    class Display : FileT
    {
        ...
        public Display(string name, string file, bool userOpen) : base(name, file, userOpen) {
            this.Name = name;
            _Path = Path.Combine(Environment.CurrentDirectory, "QSYS.LIB/test.lib/qddssrc.file", file + ".dspf");
        ...
        public static DataSet[] CreateStructs(string file, Boolean qualified = false) {
            ...
            parser.ParseFile(Path.Combine(Environment.CurrentDirectory, "QSYS.LIB/test.lib/qddssrc.file", file + ".dspf"));
